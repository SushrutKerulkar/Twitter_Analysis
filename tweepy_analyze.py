...
import numpy as np
import pandas as pd
import python_sqlserver as connection
...
class TwitterStreamer():
    ...
    def stream_tweets(self, fetched_tweets_filename, hash_tag_list):
        ...
        # fiter twitter streams to capture data by keywords
...
class TweetAnalyzer():
    """
    Funtion fro analyzing and categorizing content from tweets
    """
...
if __name__ == "__main__":
    ...
    print(df.head(20))
    df.to_sql(con=connection.engine, name='Twitter_Data',
